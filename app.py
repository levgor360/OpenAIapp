...
if selected_model == 'GPT-3.5':
    ...
    chosen_model = "gpt-4"
chosen_temperature = st.sidebar.slider('temperature', min_value=0.01, max_value=5.0, value=0.1, step=0.01)
chosen_top_p = st.sidebar.slider('top_p', min_value=0.01, max_value=1.0, value=0.9, step=0.01)
chosen_max_length = st.sidebar.slider('max_length', min_value=32, max_value=10000, value=120, step=8)
